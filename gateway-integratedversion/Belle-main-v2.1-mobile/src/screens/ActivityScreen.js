...
export default function ActivityScreen({ navigation }) {
  ...
  const handleClearActivity = async () => {
    try {
      ...
      Alert.alert('Success', 'All activity has been cleared.');
    } catch (err) {
      console.error('Error clearing activity:', err);
      Alert.alert('Error', 'Failed to clear activity. Please try again.');
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          ...
          <TouchableOpacity style={styles.filterButton} onPress={() => setShowClearModal(true)}>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalTitle}>Clear Activity</Text>
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity style={[styles.modalButton, styles.modalCancel]} onPress={() => setShowClearModal(false)}>
                <Text style={styles.modalButtonTextCancel}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.modalButton, styles.modalConfirm]} onPress={handleClearActivity}>
