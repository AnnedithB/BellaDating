    ...
    <>
      <InfoCard setOpen={setOpen} sx={{ mb: 3 }}>
        <Stack direction="column" spacing={{ xs: 2, sm: 1 }}>
          <InfoCardAttribute label="Country" value={personalInfo.country || 'Not set'} />
          <InfoCardAttribute label="City" value={personalInfo.city || 'Not set'} />
          <InfoCardAttribute label="Address" value={personalInfo.address || 'Not set'} />
          <InfoCardAttribute label="ZIP Code" value={personalInfo.zipCode || 'Not set'} />
        </Stack>
        <IconifyIcon
