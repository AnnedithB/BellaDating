...
export default function NotificationSettingsScreen({ navigation }) {
  ...
  const handleNewMatchesToggle = async (value) => {
    setNewMatches(value);
    try {
      await userAPI.updateNotificationSettings({
        all: globalToggle,
      ...
      console.warn("Failed to update new matches setting:", error);
    }
  };

  const handleNewMessagesToggle = async (value) => {
    setNewMessages(value);
    try {
      await userAPI.updateNotificationSettings({
        all: globalToggle,
      ...
      console.warn("Failed to update new messages setting:", error);
    }
  };

  const handleAppPromotionsToggle = async (value) => {
    setAppPromotions(value);
    try {
      await userAPI.updateNotificationSettings({
        all: globalToggle,
      ...
      console.warn("Failed to update promotions setting:", error);
    }
  };
